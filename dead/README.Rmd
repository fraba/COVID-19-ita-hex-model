...
raw_dat.df <- 
  read_csv("istat-9-july-2020/comuni_giornaliero-decessi.csv.zip", 
...
all_days <- all_days[grepl("^01|^02|^03|^04|^05", all_days)]
...
sum(to_include %in% italy.sf$PRO_COM_T[italy.sf$COD_REG == 3]) / 
  sum(italy.sf$COD_REG == 3)
