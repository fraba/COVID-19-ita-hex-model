...
model_vars.df$sum_manufacturing[
  is.na(model_vars.df$sum_manufacturing)] <- 0
...
predictor_labels <- 
  c(dist_sd_lag4_diff14 = "past excess mortality",
    ...
    sum_manufacturing_log10 = "log. manufactoring employees",
    sum_services_log10 = "log. servics employees",
    sum_warehousing_log10 = "log. warehousing employees",
    sum_transport_log10 = "log. transport employees",
